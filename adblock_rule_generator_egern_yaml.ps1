# Title: AdBlock_Rule_For_Egern
# Description: 适用于Egern的域名拦截规则集中，每20分钟更新一次，确保即时同步上游减少误杀
# Homepage: https://github.com/REIJI007/AdBlock_Rule_For_Egern
# LICENSE1: https://github.com/REIJI007/AdBlock_Rule_For_Egern/blob/main/LICENSE-GPL 3.0
# LICENSE2: https://github.com/REIJI007/AdBlock_Rule_For_Egern/blob/main/LICENSE-CC-BY-NC-SA 4.0
...
$textContent = @"
# Title: AdBlock_Rule_For_Egern
# Description: 适用于Egern的域名拦截规则集，每20分钟更新一次，确保即时同步上游减少误杀
# Homepage: https://github.com/REIJI007/AdBlock_Rule_For_Egern
# LICENSE1: https://github.com/REIJI007/AdBlock_Rule_For_Egern/blob/main/LICENSE-GPL 3.0
# LICENSE2: https://github.com/REIJI007/AdBlock_Rule_For_Egern/blob/main/LICENSE-CC-BY-NC-SA 4.0
...
# 定义输出文件路径
$outputPath = "$PSScriptRoot/adblock_reject_egern.yaml"
